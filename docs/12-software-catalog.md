...
| [Proton VPN](https://protonvpn.com) | torrent-client outbound privacy (via Gluetun) | commercial VPN (paid plan for port forwarding); the Gluetun client wrapping it is MIT/FOSS. Scoped to qBittorrent only — see docs/08 |
